...
OFILES = start_screen.o mylib.o main.o game_over_screen.o game.o text.o icon.o winner_screen.o image.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = start_screen.h mylib.h game_over_screen.h game.h text.h icon.h winner_screen.h image.h
